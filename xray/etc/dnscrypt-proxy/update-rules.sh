...
curl -OL https://github.com/felixonmars/dnsmasq-china-list/raw/master/accelerated-domains.china.conf
...
curl -OL https://github.com/felixonmars/dnsmasq-china-list/raw/master/bogus-nxdomain.china.conf
...
curl -OL https://github.com/missdeer/blocklist/raw/master/toblock-without-shorturl-optimized.lst
...
curl -OL https://github.com/googlehosts/hosts/raw/master/hosts-files/dnscrypt-proxy-cloaking.txt
...
curl -OL https://raw.githubusercontent.com/jedisct1/dnscrypt-proxy/master/dnscrypt-proxy/example-dnscrypt-proxy.toml
